...
The following docs have been moved to `archive/` as internal planning and evidence history:

- Self-check prompts and audit prompts
- Session wrapup and handoff notes
- Evidence docs from internal rollout
- The full `superpower/` planning set (01~19 + evidence docs)

These are preserved for reference but are not part of the public-facing surface.
