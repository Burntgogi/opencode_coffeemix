"""
Shared harness module for coffeemix_all sandbox validation runners.
...
def get_opencode_bin() -> str:
    """Return the OpenCode binary path from env or fallback search."""
    ...
    return _DEFAULT_OPENCODE_PATHS[0]
